...
## Project Structure
    ...
    ├── collectiveinfo_35225  # Django project configurations
...
1. Clone this repo and `cd collectiveinfo_35225`
...
2. Clone this repo and `cd collectiveinfo_35225`
